...
const variants: Record<ButtonVariant, string> = {
  primary: 'bg-slate-900 text-white hover:bg-slate-800 focus-visible:ring-slate-300',
  secondary: 'bg-brand-600 text-white hover:bg-brand-700 focus-visible:ring-brand-200',
  outline: 'border border-slate-200 bg-white text-slate-700 hover:border-brand-200 hover:text-brand-700 focus-visible:ring-brand-100',
